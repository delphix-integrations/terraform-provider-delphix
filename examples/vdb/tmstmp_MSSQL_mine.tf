...
resource "delphix_vdb" "mssql_tmstmp_ac2" {
  ...
  source_data_id  = "4-MSSQL_DB_CONTAINER-4"
  engine_id       = 4
  target_group_id = "Untitled"
  vdb_name        = "vdb2"
  database_name   = "vdb2"
  #truncate_log_on_checkpoint = true #ONLY ON ASE
  #username = "bogus_user"
  #password = ""
  environment_id = "4-WINDOWS_HOST_ENVIRONMENT-1"
  ...
  timestamp = "2022-03-23T16:22:14Z"
}
